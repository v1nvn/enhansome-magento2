...
* [What is an awesome list?](https://github.com/sindresorhus/awesome/blob/master/awesome.md) ⭐ 436,352 | 🐛 69 | 📅 2026-01-28
...
* **Alokai** (*ex: Vue Storefront*) ([github.com/vuestorefront/vue-storefront](https://github.com/vuestorefront/vue-storefront) ⭐ 10,910 | 🐛 53 | 🌐 TypeScript | 📅 2026-02-09)
...
* [PhpInsights](https://github.com/nunomaduro/phpinsights) ⭐ 5,575 | 🐛 71 | 🌐 PHP | 📅 2025-11-12 - PHP quality checks (with Magento2 presets)
* [DDEV](https://github.com/ddev/ddev) ⭐ 3,485 | 🐛 147 | 🌐 Go | 📅 2026-02-10 - A open source tool for launching local web development environments in minutes. It supports PHP, Node.js, and Python.
* [markshust/docker-magento](https://github.com/markshust/docker-magento) ⭐ 2,831 | 🐛 24 | 🌐 Shell | 📅 2026-02-09 - Mark Shust's Docker Configuration for
  Magento
* [n98-magerun2](https://github.com/netz98/n98-magerun2) ⭐ 923 | 🐛 30 | 🌐 PHP | 📅 2026-02-10 - The CLI Swiss Army Knife for Magento 2.
...
* [PhpStorm Magento2 Extension](https://github.com/magento/magento2-phpstorm-plugin) ⭐ 455 | 🐛 102 | 🌐 Java | 📅 2025-11-15 - Official PhpStorm Magento2
  Extension.
* [Mage Chrome Toolbar](https://github.com/magespecialist/mage-chrome-toolbar) ⭐ 337 | 🐛 14 | 🌐 JavaScript | 📅 2024-04-22 - A MUST-HAVE Chrome Extension for
...
* [MageForge](https://github.com/OpenForgeProject/mageforge) ⭐ 13 | 🐛 2 | 🌐 PHP | 📅 2026-02-09 - Magento 2 Cli automatic Theme(s) Builder (Hyvä ready)
...
* [Deployer Magento2 Recipe](https://github.com/deployphp/deployer/blob/master/recipe/magento2.php) ⭐ 10,999 | 🐛 7 | 🌐 PHP | 📅 2026-02-05 - Magento2
...
* [Elastic Suite Integration](https://github.com/Smile-SA/elasticsuite/) ⭐ 807 | 🐛 127 | 🌐 PHP | 📅 2026-02-09 - Elastic Suite Integration.
...
* [PAYONE](https://github.com/PAYONE-GmbH/magento-2) ⭐ 28 | 🐛 10 | 🌐 PHP | 📅 2025-12-01 - PAYONE Payment Integration.
...
* [Magento Github Repository](https://github.com/magento/magento2) ⭐ 12,042 | 🐛 1,977 | 🌐 PHP | 📅 2026-02-06 - Github Repository.
...
* [Awesome PHP](https://github.com/ziadoz/awesome-php) ⭐ 32,363 | 🐛 68 | 📅 2026-01-17 - A curated List of Awesome PHP Resources.
* [Mageres](https://github.com/aleron75/mageres) ⭐ 1,008 | 🐛 2 | 🌐 PHP | 📅 2026-02-09 - Alessandro Ronchi's List of resources for Magento 1 and Magento 2.
