...
* [What is an awesome list?](https://github.com/sindresorhus/awesome/blob/master/awesome.md) ⭐ 435,650 | 🐛 67 | 📅 2026-01-28
...
* **Alokai** (*ex: Vue Storefront*) ([github.com/vuestorefront/vue-storefront](https://github.com/vuestorefront/vue-storefront) ⭐ 10,910 | 🐛 52 | 🌐 TypeScript | 📅 2025-08-21)
...
* [PhpInsights](https://github.com/nunomaduro/phpinsights) ⭐ 5,571 | 🐛 70 | 🌐 PHP | 📅 2025-11-12 - PHP quality checks (with Magento2 presets)
* [DDEV](https://github.com/ddev/ddev) ⭐ 3,480 | 🐛 141 | 🌐 Go | 📅 2026-02-07 - A open source tool for launching local web development environments in minutes. It supports PHP, Node.js, and Python.
* [markshust/docker-magento](https://github.com/markshust/docker-magento) ⭐ 2,830 | 🐛 27 | 🌐 Shell | 📅 2026-01-21 - Mark Shust's Docker Configuration for
  Magento
* [n98-magerun2](https://github.com/netz98/n98-magerun2) ⭐ 924 | 🐛 28 | 🌐 PHP | 📅 2026-02-02 - The CLI Swiss Army Knife for Magento 2.
* [Pestle](https://github.com/astorm/pestle) ⭐ 532 | 🐛 184 | 🌐 PHP | 📅 2023-04-19 - Code Generation Tool by Alan Storm.
* [Warden](https://github.com/wardenenv/warden) ⭐ 455 | 🐛 41 | 🌐 Shell | 📅 2025-11-19 - A CLI utility for working with docker-compose environments
  by [David Alger](https://davidalger.com/)
* [PhpStorm Magento2 Extension](https://github.com/magento/magento2-phpstorm-plugin) ⭐ 455 | 🐛 102 | 🌐 Java | 📅 2025-11-15 - Official PhpStorm Magento2
  Extension.
...
* [Mage](https://github.com/GrimLink/mage) ⭐ 18 | 🐛 2 | 🌐 Shell | 📅 2026-02-02 - Simplifies bin/magento commands by adding helpful shortcuts and time-saving tools to enhance your productivity.
* [MageForge](https://github.com/OpenForgeProject/mageforge) ⭐ 13 | 🐛 1 | 🌐 PHP | 📅 2026-02-05 - Magento 2 Cli automatic Theme(s) Builder (Hyvä ready)
...
* [Magento Cache Clean](https://github.com/mage2tv/magento-cache-clean) ⭐ 545 | 🐛 14 | 📅 2025-07-11 - A faster drop in replacement for bin/magento
...
* [Yireo LokiComponents](https://github.com/yireo/Yireo_LokiComponents) ⭐ 9 | 🐛 0 | 🌐 PHP | 📅 2026-02-04 - A library for building AJAX-driven form components with ease. Used by the Yireo Loki Checkout.
...
* [Deployer Magento2 Recipe](https://github.com/deployphp/deployer/blob/master/recipe/magento2.php) ⭐ 10,996 | 🐛 7 | 🌐 PHP | 📅 2026-02-05 - Magento2
...
* [Github Actions for Magento2](https://github.com/extdn/github-actions-m2) ⭐ 138 | 🐛 14 | 🌐 Shell | 📅 2026-01-20 - GitHub Actions for Magento 2 Extensions
...
* [Elastic Suite Integration](https://github.com/Smile-SA/elasticsuite/) ⭐ 807 | 🐛 128 | 🌐 PHP | 📅 2026-02-06 - Elastic Suite Integration.
* [Algolia Search Integration](https://github.com/algolia/algoliasearch-magento-2) ⭐ 188 | 🐛 4 | 🌐 PHP | 📅 2026-02-05 - Algolia Search(SaaS) Integration.
* [FastSimpleImport2](https://github.com/firegento/FireGento_FastSimpleImport2) ⭐ 136 | 🐛 37 | 🌐 PHP | 📅 2025-01-29 - Wrapper for Magento 2 ImportExport functionality, which imports products and customers from arrays.
...
* [Magento 2 Blog Extension by Magefan](https://github.com/magefan/module-blog) ⭐ 269 | 🐛 11 | 🌐 PHP | 📅 2026-01-30 - Free Blog module for Magento 2 with
...
* [Google Tag Manager](https://github.com/magepal/magento2-google-tag-manager) ⭐ 262 | 🐛 15 | 🌐 PHP | 📅 2025-06-17 - Google Tag Manager (GTM) with Data
  Layer for Magento2.
* [MagePlaza Seo](https://github.com/mageplaza/magento-2-seo-extension) ⭐ 136 | 🐛 5 | 🌐 PHP | 📅 2026-02-06 - Well documented multi purpose SEO Extension.
...
* [Disable Stock Reservation](https://github.com/AmpersandHQ/magento2-disable-stock-reservation) ⭐ 227 | 🐛 19 | 🌐 PHP | 📅 2026-01-21 - This module disables the inventory reservation logic introduced as part of MSI in Magento 2.3.3.
* [Sentry.io](https://github.com/justbetter/magento2-sentry) ⭐ 184 | 🐛 8 | 🌐 PHP | 📅 2026-01-27 - Application Monitoring and Error Tracking Software for
  Magento 2
* [Customer Force Login](https://github.com/bitExpert/magento2-force-login) ⭐ 170 | 🐛 7 | 🌐 PHP | 📅 2024-05-01 - Forces customers to log in before
  accessing certain pages.
* [Clean Admin Menu](https://github.com/redchamps/clean-admin-menu) ⭐ 163 | 🐛 0 | 🌐 PHP | 📅 2025-04-16 - Merges 3rd party extensions to a single menu.
* [FireGento Fast Simple Import](https://github.com/firegento/FireGento_FastSimpleImport2) ⭐ 136 | 🐛 37 | 🌐 PHP | 📅 2025-01-29 - Wrapper for Magento 2
  ImportExport functionality, which imports products and customers from arrays
* [Magento 2 Import Framework](https://github.com/techdivision/import) ⭐ 128 | 🐛 10 | 🌐 PHP | 📅 2025-10-24 - A library supporting generic Magento 2 import
  functionality
* [Checkout Tester](https://github.com/yireo/Yireo_CheckoutTester2) ⭐ 94 | 🐛 3 | 🌐 PHP | 📅 2024-10-24 - Extension to quickly test Checkout changes.
* [Preview Checkout Success Page](https://github.com/magepal/magento2-preview-checkout-success-page) ⭐ 78 | 🐛 3 | 🌐 PHP | 📅 2026-01-14 - quickly and
  easily preview and test your order confirmation page, without the need to placing a new order each time.
* [Guest to Customer](https://github.com/magepal/magento2-guest-to-customer) ⭐ 68 | 🐛 5 | 🌐 PHP | 📅 2026-01-07 - Quickly and easily convert existing guest
  checkout customers to registered customers.
* [shkoliar/magento-grid-colors](https://github.com/shkoliar/magento-grid-colors) ⭐ 61 | 🐛 2 | 🌐 JavaScript | 📅 2021-10-05 - Magento 2 Grid Colors module for
...
* [PAYONE](https://github.com/PAYONE-GmbH/magento-2) ⭐ 28 | 🐛 9 | 🌐 PHP | 📅 2025-12-01 - PAYONE Payment Integration.
...
* [Ethan3600/magento2-CronjobManager](https://github.com/Ethan3600/magento2-CronjobManager) ⭐ 363 | 🐛 14 | 🌐 PHP | 📅 2025-05-01 - Cron Job Manager for
  Magento 2.
* [Fastly Extension](https://github.com/fastly/fastly-magento2) ⭐ 157 | 🐛 35 | 🌐 PHP | 📅 2026-02-03 - Magento 2 fastly integration.
...
* [Magento 2 Ngrok](https://github.com/shkoliar/magento-ngrok) ⭐ 47 | 🐛 5 | 🌐 PHP | 📅 2023-05-29 - Magento 2 Ngrok Integration
...
* [roma-glushko/magento2-dev-plus-exam](https://github.com/roma-glushko/magento2-dev-plus-exam) ⭐ 77 | 🐛 0 | 🌐 PHP | 📅 2019-11-23 - Preparation notes for
...
* [Magento Github Repository](https://github.com/magento/magento2) ⭐ 12,038 | 🐛 1,980 | 🌐 PHP | 📅 2026-02-06 - Github Repository.
...
* [Magento 2 Architecture](https://github.com/magento/architecture) ⭐ 280 | 🐛 66 | 📅 2025-01-21 - A place where Magento architectural discussions
  happen.
...
* [Awesome PHP](https://github.com/ziadoz/awesome-php) ⭐ 32,347 | 🐛 68 | 📅 2026-01-17 - A curated List of Awesome PHP Resources.
* [Mageres](https://github.com/aleron75/mageres) ⭐ 1,008 | 🐛 2 | 🌐 PHP | 📅 2026-02-03 - Alessandro Ronchi's List of resources for Magento 1 and Magento 2.
