...
* [What is an awesome list?](https://github.com/sindresorhus/awesome/blob/master/awesome.md) ⭐ 437,047 | 🐛 69 | 📅 2026-01-28
...
* **Alokai** (*ex: Vue Storefront*) ([github.com/vuestorefront/vue-storefront](https://github.com/vuestorefront/vue-storefront) ⭐ 10,911 | 🐛 53 | 🌐 TypeScript | 📅 2026-02-09)
...
* [PhpInsights](https://github.com/nunomaduro/phpinsights) ⭐ 5,578 | 🐛 71 | 🌐 PHP | 📅 2025-11-12 - PHP quality checks (with Magento2 presets)
* [DDEV](https://github.com/ddev/ddev) ⭐ 3,492 | 🐛 145 | 🌐 Go | 📅 2026-02-13 - A open source tool for launching local web development environments in minutes. It supports PHP, Node.js, and Python.
* [markshust/docker-magento](https://github.com/markshust/docker-magento) ⭐ 2,830 | 🐛 24 | 🌐 Shell | 📅 2026-02-09 - Mark Shust's Docker Configuration for
  Magento
* [n98-magerun2](https://github.com/netz98/n98-magerun2) ⭐ 922 | 🐛 27 | 🌐 PHP | 📅 2026-02-12 - The CLI Swiss Army Knife for Magento 2.
* [Pestle](https://github.com/astorm/pestle) ⭐ 532 | 🐛 184 | 🌐 PHP | 📅 2023-04-19 - Code Generation Tool by Alan Storm.
* [Warden](https://github.com/wardenenv/warden) ⭐ 455 | 🐛 41 | 🌐 Shell | 📅 2026-02-12 - A CLI utility for working with docker-compose environments
...
* [MageForge](https://github.com/OpenForgeProject/mageforge) ⭐ 14 | 🐛 4 | 🌐 PHP | 📅 2026-02-12 - Magento 2 Cli automatic Theme(s) Builder (Hyvä ready)
...
* [Yireo LokiComponents](https://github.com/yireo/Yireo_LokiComponents) ⭐ 9 | 🐛 0 | 🌐 PHP | 📅 2026-02-12 - A library for building AJAX-driven form components with ease. Used by the Yireo Loki Checkout.
...
* [Deployer Magento2 Recipe](https://github.com/deployphp/deployer/blob/master/recipe/magento2.php) ⭐ 11,004 | 🐛 7 | 🌐 PHP | 📅 2026-02-05 - Magento2
...
* [Elastic Suite Integration](https://github.com/Smile-SA/elasticsuite/) ⭐ 807 | 🐛 120 | 🌐 PHP | 📅 2026-02-12 - Elastic Suite Integration.
...
* [Magento Github Repository](https://github.com/magento/magento2) ⭐ 12,042 | 🐛 1,975 | 🌐 PHP | 📅 2026-02-12 - Github Repository.
