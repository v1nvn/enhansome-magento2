...
* [What is an awesome list?](https://github.com/sindresorhus/awesome/blob/master/awesome.md) ⭐ 437,260 | 🐛 69 | 📅 2026-01-28
...
* [DDEV](https://github.com/ddev/ddev) ⭐ 3,491 | 🐛 147 | 🌐 Go | 📅 2026-02-13 - A open source tool for launching local web development environments in minutes. It supports PHP, Node.js, and Python.
* [markshust/docker-magento](https://github.com/markshust/docker-magento) ⭐ 2,830 | 🐛 23 | 🌐 Shell | 📅 2026-02-09 - Mark Shust's Docker Configuration for
  Magento
...
* [MageForge](https://github.com/OpenForgeProject/mageforge) ⭐ 14 | 🐛 4 | 🌐 PHP | 📅 2026-02-13 - Magento 2 Cli automatic Theme(s) Builder (Hyvä ready)
...
* [Magento Github Repository](https://github.com/magento/magento2) ⭐ 12,040 | 🐛 1,976 | 🌐 PHP | 📅 2026-02-12 - Github Repository.
